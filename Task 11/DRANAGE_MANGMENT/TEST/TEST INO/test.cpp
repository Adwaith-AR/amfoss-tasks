...
void loop()
{
          ...
          sent_msg("bard1 water level: 100");
              sent_msg("bard1 obstacles: 100");
                  sent_msg("bard1 gas: 100");
                      sent_msg("bard2 water level: 100");
                          sent_msg("bard2 obstacles: 100");
                              sent_msg("bard2 gas: 100");
                                  sent_msg("bard3 water level: 100");
                                      sent_msg("bard3 obstacles: 100");
                                          sent_msg("bard3 gas: 100");
                                          delay(1000); // Delay between readings
...
// Function to activate a channel on the TCA9548A I2C multiplexe100