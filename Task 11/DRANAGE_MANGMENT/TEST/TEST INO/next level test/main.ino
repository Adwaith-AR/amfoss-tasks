...
void SentData( String SensorType, float value)
{
          String msg = "bard" + String(BoardNumber) + " " + String(SensorType) + ": " + String(int(value));
...
void loop()
{
          ...
          else
          {
                    ...
                    SentData( "water level", distance1); // Send distance to MQTT
          }
          ...
          else
          {
                    ...
                    SentData( "obstacles", distance2); // Send distance to MQTT
          }
          ...
          SentData( "analog_methane_level", analogValue);

          // Send digital value to MQTT

          SentData( "digital_methane_level", digitalValue);
