...
value = [12,300,400,23,984,883,72,982,382,82,832,3,39,82,872,82,72,983,93,82,9283,92,92,839,298,92,832,389,282,828,832,839]
...
try:
    while True:
        send_message("bard2 water level: "+str(random.choice(value)))
